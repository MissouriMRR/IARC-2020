...
class TimeModuleInFrame:
    ...
    def setup(self):
        ...
        for size in [20, 40, 80, 100, 120]:
            ...
            cv2.rectangle(
                depth_image, (213, 240), (426 + size, 480 + size), (255), thickness=4
            )
        ...
        for n_obj in range(4, 9):
            ...
            cv2.rectangle(
                color_image, (213, 240), (426, 480), (255, 255, 255), thickness=4
            )
            ...
            for location in [
                ...
                cv2.circle(
                    depth_image, location, self.DEFAULT_RADIUS, (255), thickness=4
                )
