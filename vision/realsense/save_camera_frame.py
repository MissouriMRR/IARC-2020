...
clipping_distance_in_meters = 12 #1 meter (changed to 12)
...
while True:
    ...
    if (cv2.getWindowProperty('Align Example', 0) == -1):
        cv2.destroyAllWindows()
        break

    # Press esc or 'q' to take the pictures and close the window
